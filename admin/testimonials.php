            ...
            <div class="col-lg-12">
                <ul class="nav nav-pills mb-3">
                    <li class="nav-item"><a href="#list-view" data-toggle="tab"
                            class="nav-link btn-danger mr-1 show active">Temoignages non validés</a></li>
                    <li class="nav-item"><a href="testimonials-valid.php" class="nav-link btn-success">validations</a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-12">
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><strong>Liste de temoignage non validés</strong></h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            $posts = "SELECT * FROM testimonials WHERE status='0'";
                                            ...
                                            if (mysqli_num_rows($posts_run) > 0) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="5" class="bg-danger text-danger text-center">Pas de
                                                        Temoignages Trouvés</td>
                                                </tr>
