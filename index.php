...
<body>
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <p class="mb-5 fs-5">ministère de chant issu de l’aumônerie protestante de l’Université
                                    Evangelique en Afrique (UEA), située à Bukavu, en République Démocratique du Congo
                                    (RDC). rassemblant des jeunes passionnés par la louange et engagés dans la mission
                                    d’annoncer la Bonne Nouvelle de Jésus-Christ à travers le chant.
                                </p>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">ETOILE
                                    DE LOUANGE</h4>
    ...
    <div class="container-fluid about py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7"
                    style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(img/etoile.png);">
                        ...
                        <div class="col-12">
                            <div
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="mb-0">Guider l’assemblée à travers les chants de louange, de repentance,
                                        d’offrande et de communion, pour favoriser une réponse vivante à la Parole de
                                        Dieu
                                    </p>
                        ...
                        <div class="col-12">
                            <div
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="mb-0">Former les membres à une pratique vocale juste et harmonieuse, à la
                                        vie chorale dans l’écoute fraternelle, ainsi qu’à une meilleure intelligence de
                                        la liturgie.
                                    </p>
                        ...
                        <div class="col-12">
                            <div
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="mb-0">Servir la liturgie par des chants préparés avec amour et fidélité,
                                        afin que la beauté du chant élève les âmes et exprime la foi du peuple de Dieu.
                                    </p>
                        ...
                        <div class="col-12">
                            <div
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="mb-0">Bâtir une communauté chorale animée par la prière, la fraternité et
                                        la foi, où chacun trouve soutien et croissance spirituelle dans le Christ.
                                    </p>
                    ...
                    foreach ($homeCategory_run as $homeItems) {
                        ...
                        <div class="packages-item">
                            <div class="packages-img">
                                <img src="admin/uploads/<?= $homeItems['profile']; ?>"
                                    class="img-fluid w-100 rounded-top membre-img" alt="Image">
                            </div>
                            <div class="packages-content bg-light">
                                <div class="p-4 pb-0">
                                    <h5 class="mb-0">
                                        <?= $homeItems['nom'] . ' ' . $homeItems['postnom'] . ' ' . $homeItems['prenom']; ?></h5>
                                ...
                                <div class="row bg-primary rounded-bottom mx-0">
                                    <div class="col-6 text-start px-0">
                                        <a href="detail-membre.php?id=<?= $homeItems['id']; ?>"
    ...
    <div class="container-fluid testimonial py-2">
        <div class="container py-5">
            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                <h5 class="section-title px-3">Temoignages</h5>
