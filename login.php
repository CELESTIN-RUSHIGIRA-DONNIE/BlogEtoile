...
<head>
    <meta charset="utf-8">
    <title>Login - etoile de louange</title>
                ...
                <div class="col-lg-6">
                    <div class="rounded p-5">
                        <?php if (isset($_SESSION['message'])) { ?>
                            <div
                                class="col-xl-12 alert alert-<?php echo $_SESSION['msg_type']; ?> solid alert-dismissible fade show">
                        ...
                        <?php } ?>
                        <h1 class="text-center mb-4">Connectez-vous ici</h1>
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="https://www.facebook.com/share/1G6g6YW1Xu/?mibextid=wwXIfr"><i
                                class="fab fa-facebook me-2"></i>Facebook</a>
                        <a href="https://www.tiktok.com/@etoiledelouangeuea?lang=en"><i class="fab fa-tiktok me-2"></i>
                            TikTok</a>
                        <a href="#"><i class="fab fa-instagram me-2"></i> Instagram</a>
                        <a href="https://www.youtube.com/@etoiledelouangeUEA"><i class="fab fa-youtube me-2"></i>
                            YouTube</a>
                    </div>
                </div>
