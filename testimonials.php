...
<head>
    <meta charset="utf-8">
    <title>Temoignage - Etoile de Louange</title>
...
<body>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="testimonials.php" class="dropdown-item active">Temoignage</a>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-3 mb-4"><i class="fa fa-star"></i> Temoignages !</h4>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Acceuil</a></li>
                <li class="breadcrumb-item"><a href="#">Temoignage</a></li>
                <li class="breadcrumb-item active text-white">Nous temoigner !</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid booking">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h5 class="section-booking-title pe-3">Temoignage</h5>
                ...
                <div class="col-lg-6">
                    <h1 class="text-white mb-3">Formulaire de Temoignage</h1>
