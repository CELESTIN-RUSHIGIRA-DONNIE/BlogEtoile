...
<head>
    <meta charset="utf-8">
    <title>404 - Etoile de Louange</title>
        ...
        <div class="container py-5 text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4 text-dark">Page Non Trouvée</h1>
                    <p class="mb-4 text-dark">Désolé, la page que vous recherchez n’existe pas sur notre site !
                        Vous pouvez retourner à la page d’accueil ou utiliser la recherche.</p>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="index">Retourner à l'accueil</a>
                </div>
            </div>
        </div>
    </div>
